...
export const PERMISSION_CATALOG = [
  ...
  { code: 'appointment:view', name: '查看预约到店', module: 'appointment' },
  { code: 'appointment:edit', name: '管理预约与到店核销', module: 'appointment' },
  { code: 'card:view', name: '查看客户卡项', module: 'card' },
  { code: 'card:edit', name: '开卡、核销与充值', module: 'card' },
  { code: 'card:adjust', name: '手工调整卡内次数与余额', module: 'card' },
  ...
  { code: 'cockpit:view', name: '查看老板驾驶舱', module: 'dashboard' },
